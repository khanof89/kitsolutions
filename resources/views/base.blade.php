...
<div class="wrapper">
    ...
    <section class="row background-grey text-center">
        <div class="container">
            <h3>DO YOU LIKE WHAT YOU SEE</h3> <a href="#" class="button color rounded"><span>Buy POLO</span></a>
        </div>
    </section>
    <!-- CALL TO ACTION -->
    ...
    <section class="p-b-0">
        <div class="container">
            ...
            <div class="portfolio">
                <!-- Portfolio Items -->
                <div id="isotope" class="isotope portfolio-items" data-isotope-item-space="4" data-isotope-mode="masonry" data-isotope-col="3" data-isotope-item=".portfolio-item">
