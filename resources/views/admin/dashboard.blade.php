...
<head>
    ...
    <!-- page stylesheets -->
    <link rel="stylesheet" href="/administrator/vendor/bower-jvectormap/jquery-jvectormap-1.2.2.css"/>
            ...
            <div class="header-inner">
                <div class="navbar-item navbar-spacer-right brand hidden-lg-up">
                    ...
                    <a class="brand-logo hidden-xs-down">
                        <img src="/administrator/images/logo_white.png" alt="logo"/>
                    </a>
                    <!-- /logo -->
                </div>
            ...
            <div class="modal-content">
                <div class="chat-header">
                    ...
                    <div class="chat-conversation-title">
                        <img src="/administrator/images/face1.jpg" class="avatar avatar-xs img-circle m-r-1 pull-left" alt="">
...
<!-- page scripts -->
<script src="/administrator/vendor/flot/jquery.flot.js"></script>
<script src="/administrator/vendor/flot/jquery.flot.resize.js"></script>
<script src="/administrator/vendor/flot/jquery.flot.stack.js"></script>
<script src="/administrator/vendor/flot-spline/js/jquery.flot.spline.js"></script>
<script src="/administrator/vendor/bower-jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/administrator/data/maps/jquery-jvectormap-us-aea.js"></script>
<script src="/administrator/vendor/jquery.easy-pie-chart/dist/jquery.easypiechart.js"></script>
<script src="/administrator/vendor/noty/js/noty/packaged/jquery.noty.packaged.min.js"></script>
<script src="/administrator/scripts/helpers/noty-defaults.js"></script>
<!-- end page scripts -->

<!-- initialize page scripts -->
<script src="/administrator/scripts/dashboard/dashboard.js"></script>
