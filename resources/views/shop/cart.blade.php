                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="#">
                                    <img src="{{$item->image}}" alt="Bolt Sweatshirt">
                                </a>
                            ...
                            <td class="cart-product-price">
                                <span class="amount" id="amount-{{$item->id}}" data-amount="{{$item->price}}">{{env('CURENCY') . $item->price}}</span>
                            </td>

                            <td class="cart-product-quantity">
                                <div class="quantity">
                                    <input type="button" class="minus" value="-" data-id="{{$item->id}}">
                                    <input type="text" class="qty" value="{{$item->quantity}}" name="quantity" id="quantity-{{$item->id}}">
                                    <input type="button" class="plus" value="+" data-id="{{$item->id}}">
                                </div>
                            </td>

                            <td class="cart-product-subtotal">
                                <span class="amount">{{env('CURENCY')}} <div class="total-{{$item->id}}">{{$item->quantity * $item->price}}</div></span>
                            </td>
                        </tr>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="cart-product-name text-right">
                                        <span class="amount color lead"><strong class="cartTotal" data-value="{{$total}}">INR{{$total}}</strong></span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <a href="#" class="button color button-3d rounded icon-left float-right"><span>Proceed to Checkout</span></a>
                    </div>
                </div>
            </div>
        </div>
